...
String masterCardUID = "35 9B DF 00"; 
...
void loop() {
  ...
  if (mfrc522.PICC_IsNewCardPresent() && mfrc522.PICC_ReadCardSerial()) {
    ...
    Serial.print("Ma UID cua the nay la: ");
    Serial.println(currentUID); 
    
  
    if (currentUID == masterCardUID) {
      openDoor("THE TU OK");
    } else {
      Serial.println("THE LA! TỪ CHỐI MỞ CỬA.");
      accessDenied(); 
    }
